...
from ebiose.generated_cloud_client.api.api_key import delete_api_key, self_delete_api_key, self_get_api_keys
...
class EbioseAPIClient:
    ...
    def end_forge_cycle(
        cls,
        forge_cycle_id: str,
        winning_agents: list[Agent] | None = None, # should create new agents server side with full metabolism
        ...
        agent_metabolism_updates: dict[str, float] | None = None, # {"agent-...": 0.5, ...}
    ):
